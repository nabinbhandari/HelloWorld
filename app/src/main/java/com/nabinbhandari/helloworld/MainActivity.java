...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView mPreview = findViewById(R.id.preview);
    ...
    private static void setupRichEditor(Activity activity, final RichEditor mEditor) {
        mEditor.setEditorFontSize(16);
        mEditor.setPadding(8, 8, 8, 8);
        mEditor.setPlaceholder("Write a message...");
        ...
        activity.findViewById(R.id.action_insert_bullets).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEditor.setBullets();
            }
        ...
        activity.findViewById(R.id.action_insert_numbers).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEditor.setNumbers();
            }
